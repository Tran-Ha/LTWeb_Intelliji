...
@WebServlet(name = "addBookQuantity", urlPatterns = "/addBookQuantity")
public class AddBookQuantity extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("updateBookQuantity").forward(request, response);
    }
}
