...
<%
    ...
    List<Book> all = bookEntity.search(txtSearch, index, pageSize);
                                            ...
                                            <tr class="ui-jqgrid-labels" role="rowheader">
                                                ...
                                                <th id="jqgrid_PriceDiscount" role="columnheader" class=""
                                                    ...
                                                    <div id="jqgh_jqgrid_PriceDiscount"
                                                         class="ui-jqgrid-sortable">Gía giảm %</div></th>
                                                <!--  -->
                                        ...
                                        <tr>
                                            ...
                                            <td id="pjqgrid_center" align="center"
                                                ...
                                                <table cellspacing="0" cellpadding="0" border="0"
                                                    ...
                                                    <form action="search-result.jsp?txtSearch=${txtSearch}" method="post">
                                                        <tbody>
                                                        <tr>
