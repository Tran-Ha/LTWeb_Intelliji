                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="account-area text-right">
                        <ul>
                            ...
                            <li><a href="html/login_signup.html">Đăng nhập</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-4 col-12">
                    <div class="header-search ptb-10">
                        <form action="html/search-result.html" method="GET">
                            <input type="text" placeholder="Tìm sản phẩm, danh mục, thương hiệu,..." />
                            <a href="html/search-result.html"><i class="fa fa-search"></i></a>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="my-cart ptb-10">
                        <ul>
                            <li><a href="html/cart.html" class="nowrap"><i class="fa fa-shopping-cart"></i>Giỏ hàng</a>
                                <span>2</span>
                        ...
                        <div class="product-wrapper">
                            ...
                            <div class="product-link">
                                ...
                                <div class="add-to-link">
                                    <ul>
                                        <li><a href="html/product-details.html" title="Chi tiết"><i
        ...
        <div class="row">
            ...
            <div class="post-active owl-carousel text-center">
                ...
                <div class="col-lg-12">
                    <div class="single-post">
                        <div class="post-img">
                            <a href="html/blog-details.html"><img src="img/post/2.jpg" alt="post" /></a>
                            <div class="blog-date-time">
                                <span class="day-time">06</span>
                                <span class="moth-time">Dec</span>
                            </div>
                        ...
                        <div class="post-content">
                            <h3><a href="html/blog-details.html">Tủ sách quý cô</a></h3>
                ...
                <div class="col-lg-12">
                    <div class="single-post">
                        <div class="post-img">
                            <a href="html/blog-details.html"><img src="img/post/3.jpg" alt="post" /></a>
                            <div class="blog-date-time">
                        ...
                        <div class="post-content">
                            <h3><a href="html/blog-details.html">Những sách hay về tâm lí tháng 10</a></h3>
                ...
                <div class="col-lg-12">
                    <div class="single-post">
                        <div class="post-img">
                            <a href="html/blog-details.html"><img src="img/post/4.jpg" alt="post" /></a>
                            <div class="blog-date-time">
                        ...
                        <div class="post-content">
                            <h3><a href="html/blog-details.html">Những đầu sách mới tháng 11</a></h3>
