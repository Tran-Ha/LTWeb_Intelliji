                    ...
                    <div class="menu-area">
                        <nav>
                            <ul>
                                ...
                                <li class="active"><a href="html/blog.html">Blog<i class="fa fa-angle-down"></i></a>
            ...
            <div class="col-lg-12">
                <div class="breadcrumbs-menu">
                    <ul>
                        ...
                        <li><a href="html/about.html" class="active">Giới thiệu</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="skill-content">
                    ...
                    <a href="html/blog.html">Xem thêm<i class="fa fa-long-arrow-right"></i></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
