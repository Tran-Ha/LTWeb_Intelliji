...
<body
	...
	<!-- start	main panel -->
	<%
		String idString = request.getParameter("id-book");
		int id = Integer.parseInt(idString);

		Book book = BookEntity.get(id);
											...
											<fieldset>
												<div class="section col-xs-12 ">
													...
													<div class="col-md-9 col-xs-12">
														<section>
															<label class="label">Tiêu đề</label> <label
												...
												<div class="section col-xs-12 ">
													...
													<div class="col-md-9 col-xs-12">
														<section>
															...
															<textarea style="height: 200px; width: 100%;">${book.getDescription()}</textarea>
														</section>
													</div>
												</div>
											</fieldset>
