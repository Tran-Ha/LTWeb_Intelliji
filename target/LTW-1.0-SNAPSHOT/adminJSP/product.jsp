				...
				<section id="widget-grid">
					...
					<div class="widget-body-toolbar margin-top-10 form-horizontal"
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<select class="form-control" id="ProductGroupId"
											...
											<option value="235790">Tiểu thuyết</option>
											<option value="235794">Ngôn tình</option>
											<option value="235793">Lập trình</option>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label class="col-md-4 control-label">Ngôn ngữ</label>
									<div class="col-md-8">
													...
													<tr class="ui-jqgrid-labels" role="rowheader">
														...
														<th id="jqgrid_Name" role="columnheader" class=""
															...
															<div id="jqgh_jqgrid_Name" class="ui-jqgrid-sortable">
																Tên sản phẩm<span class="s-ico" style="">
															</div></th>
														<!-- type -->
														...
														<th id="jqgrid_PriceDiscount" role="columnheader" class=""
															...
															<div id="jqgh_jqgrid_PriceDiscount"
																class="ui-jqgrid-sortable">Chiết khấu %</div></th>
														<!--  -->
														<th id="jqgrid_IsSale" role="columnheader" class=""
															style="width: 50px;"><span
															class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
															style="cursor: col-resize;">&nbsp;</span>
															<div id="jqgh_jqgrid_IsBest" class="ui-jqgrid-sortable">
																Khuyến mãi</div></th>
														<!-- bestSale -->
														<th id="jqgrid_IsBest" role="columnheader" class=""
															...
															class="ui-jqgrid-resize ui-jqgrid-resize-ltr"
															style="cursor: col-resize;">&nbsp;</span>
															<div id="jqgh_jqgrid_IsBest" class="ui-jqgrid-sortable">Bán
																chạy</div></th>
														<!-- new -->
												...
												<tbody>
													...
													<tr role="row" id="197585" tabindex="-1"
														...
														<td role="gridcell" style="text-align: left;"
															...
															style="text-decoration: none;" href="createProduct.jsp">Tôi thấy hoa vàng trên cỏ xanh</a></td>
														<!-- type -->
														<td role="gridcell" style="" title="Tiểu thuyết"
															aria-describedby="jqgrid_ProductGroupName">Tiểu thuyết</td>
														<!-- image -->
														...
														<td role="gridcell" style="text-align: center;"
															title="---"
															aria-describedby="jqgrid_TrackingInventoryText">512</td>
														<!-- price -->
														<td role="gridcell" style="text-align: right;"
															title="550,000" aria-describedby="jqgrid_Price">550,000</td>
														<!-- discount -->
														<td role="gridcell" style="text-align: right;" title="0"
															aria-describedby="jqgrid_PriceDiscount">10</td>
														<!--  -->
														<td role="gridcell" style="text-align: center;" title=""
															aria-describedby="jqgrid_IsBest"><input
															type="checkbox" checked="checked" value="true"
															offval="no" disabled="disabled"></td>
														<!-- bestSale -->
														<td role="gridcell" style="text-align: center;" title=""
															aria-describedby="jqgrid_IsBest"><input
															type="checkbox" checked="checked" value="true"
												...
												<tr>
														...
														<table cellspacing="0" cellpadding="0" border="0"
															...
															<tbody>
																<tr>
																	...
																	<td>Page</td>
																	<td dir="ltr"><input class="ui-pg-input"
																		type="text" size="2" maxlength="7" value="0"
																		role="textbox"></td>
																	<td>of</td>
																	<td><span id="sp_1_pjqgrid">2</span></td>
																	<td class="ui-pg-button ui-state-disabled"
																		style="width: 4px;"><span class="ui-separator"></span></td>
																	<td id="next_pjqgrid"
													...
													<td id="pjqgrid_right" align="right">
														<div dir="ltr" style="text-align: right"
															class="ui-paging-info">View 1 - 25 of 30</div>
													</td>
												</tr>
											</tbody>
										</table>
